...
/**
 * Java implementation of the AIBE cryptographic scheme.
 * Converted from SchemeAIBE.py based on JPBC library.
 * This scheme is only applicable to symmetric groups of prime orders.
 */
@SuppressWarnings("unchecked")
public class SchemeAIBE
{
    ...
    public SchemeAIBE(Pairing pairing)
    {
